...
<%
    ...
    String sReturnUrl = "http://localhost:8085/mater/main/load-page?pageName=intro/checkplus_success.jsp";      // 성공시 이동될 URL
    String sErrorUrl = "http://localhost:8085/mater/main/load-page?pageName=intro/checkplus_fail.jsp";          // 실패시 이동될 URL
